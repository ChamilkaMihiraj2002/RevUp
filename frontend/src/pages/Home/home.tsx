...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navigation */}
      <nav className="border-b border-cyan-200/80 bg-gradient-to-r from-blue-50 via-cyan-50 to-blue-100 shadow-sm sticky top-0 z-50">
        <div className="mx-auto px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <div className="bg-cyan-600 rounded-lg p-2 transform transition-transform hover:scale-110">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="pt-8">
              ...
              <div className="flex items-center space-x-4 mt-8">
                ...
                <button className="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-3 rounded-md text-base font-medium shadow-sm transform transition-all hover:shadow-md hover:-translate-y-1">
                  Watch Demo
                </button>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg transform transition-all hover:shadow-xl">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gradient-to-br from-blue-100 to-cyan-100 border border-blue-200 rounded-lg p-4 transform transition-all hover:scale-105 cursor-pointer">
                    ...
                    <div className="bg-gradient-to-br from-green-100 to-cyan-100 border border-green-200 rounded-lg p-4 transform transition-all hover:scale-105 cursor-pointer">
                      <div className="flex items-center space-x-2 mb-3">
      ...
      <section className="bg-white py-16 px-8 shadow-inner">
        <div className="mx-auto">
          <div className="grid grid-cols-4 gap-8">
            <div className="text-center transform transition-all hover:scale-110 cursor-pointer">
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-20 px-8">
        <div className="mx-auto">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div 
              className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all transform hover:-translate-y-2 cursor-pointer"
              onMouseEnter={() => setHoveredFeature(0)}
              onMouseLeave={() => setHoveredFeature(null)}
            >
              <div className={`bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-3 w-fit mb-4 transform transition-transform ${hoveredFeature === 0 ? 'scale-110 rotate-6' : ''}`}>
            ...
            <div 
              ...
              onMouseLeave={() => setHoveredFeature(null)}
            >
              <div className={`bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-3 w-fit mb-4 transform transition-transform ${hoveredFeature === 1 ? 'scale-110 rotate-6' : ''}`}>
            ...
            <div 
              ...
              onMouseLeave={() => setHoveredFeature(null)}
            >
              <div className={`bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-3 w-fit mb-4 transform transition-transform ${hoveredFeature === 2 ? 'scale-110 rotate-6' : ''}`}>
            ...
            <div 
              ...
              onMouseLeave={() => setHoveredFeature(null)}
            >
              <div className={`bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-3 w-fit mb-4 transform transition-transform ${hoveredFeature === 3 ? 'scale-110 rotate-6' : ''}`}>
            ...
            <div 
              ...
              onMouseLeave={() => setHoveredFeature(null)}
            >
              <div className={`bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-3 w-fit mb-4 transform transition-transform ${hoveredFeature === 4 ? 'scale-110 rotate-6' : ''}`}>
            ...
            <div 
              ...
              onMouseLeave={() => setHoveredFeature(null)}
            >
              <div className={`bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-3 w-fit mb-4 transform transition-transform ${hoveredFeature === 5 ? 'scale-110 rotate-6' : ''}`}>
        ...
        <div className="w-full px-8">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-bold text-white text-lg">RevUp</span>
